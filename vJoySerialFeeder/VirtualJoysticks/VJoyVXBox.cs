...
namespace vJoySerialFeeder
{
    ...
    internal static partial class NativeMethods
    {
        ...
        [DllImport("vXboxInterface.dll")]
        internal static extern bool PlugIn(uint idx);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool UnPlug(uint idx);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool isControllerExists(uint idx);

        // axes
        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetAxisX(uint idx, short val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetAxisY(uint idx, short val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetAxisRx(uint idx, short val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetAxisRy(uint idx, short val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetTriggerL(uint idx, byte val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetTriggerR(uint idx, byte val);

        // buttons
        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnA(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnB(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnX(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnY(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnStart(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnBack(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnLT(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnRT(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnLB(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnRB(uint idx, bool val);

        [DllImport("vXboxInterface.dll")]
        internal static extern bool SetBtnGD(uint idx, bool val);
